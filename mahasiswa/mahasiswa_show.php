    ...
    <div class="card-body">
        ...
        <nav class="mb-5">
            ...
            if ($page == 1) {
                ...
                echo '<li class="page-item"><a class="page-link" href="?page=mahasiswa-show&halaman=' . $link_prev . '" arialabel="Previous"><span
...
'
                    ...
                    '"><a
class="page-link"
href="?page=mahasiswa-show&halaman='
                    .
                    $i
                    .
                    '">'
...
class="page-item"><a
class="page-link"
href="?page=mahasiswa-show&halaman=' . $jumlah_page .
                    '">Last</a></li>';
            }
            ?>
            </ul>
