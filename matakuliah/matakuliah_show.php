    ...
    <div class="card-body">
        <form action="?page=matakuliah-show" method="POST">
            <div class=" input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukan Id atau Kode..." name="keyword">
        ...
        <nav class="mb-5">
            ...
            if ($page == 1) {
                ...
                echo '<li class="page-item"><a class="page-link" href="?page=matakuliah-show&halaman=' . $link_prev . '" arialabel="Previous"><span
...
'
                    ...
                    '"><a
class="page-link"
href="?page=matakuliah-show&halaman='
                    .
                    $i
                    .
                    '">'
...
class="page-item"><a
class="page-link"
href="?page=matakuliah-show&halaman=' . $jumlah_page .
                '">Last</a></li>';
